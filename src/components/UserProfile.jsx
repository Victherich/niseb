...
const UserDetailsPage = ({ userId }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${domain}/get_user_by_id.php?id=${userId}`)
      .then(res => {
        if (res.data.success) {
  ...
  const handleSave = () => {
    axios.post(`${domain}/update_user_phone.php`, {
      id: user.id,
      phone: newPhone,
    }).then(res => {
      if (res.data.success) {
      ...
      {user ? (
        <>
          <Card>
            ...
            {/* <InfoRow><Label>ID:</Label><Value>{user.id}</Value></InfoRow> */}
            <InfoRow><Label>Name:</Label><Value>{user.name}</Value></InfoRow>
            ...
            <InfoRow><Label>Role:</Label><Value>{user.role}</Value></InfoRow>
            <InfoRow><Label>Created At:</Label><Value>{new Date(user.created_at).toLocaleString()}</Value></InfoRow>
          </Card>
